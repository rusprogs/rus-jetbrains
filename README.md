...
Due to the GitHub administration's ongoing discrimination against users based on their nationality, including deletion of all information and accounts, as well as the impossibility of securely storing project code on this hosting service for this reason, **all data and further development of the project have been moved to [GitFlic](https://gitflic.ru/project/russky/rus-jetbrains)**.